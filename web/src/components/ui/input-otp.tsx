...
function InputOTPSlot({
  ...
  return (
    <div
      ...
      className={cn(
        // Each slot is an independent rounded box (vs. shadcn's connected default)
        // so the group reads as six separate cells.
        'border-input dark:bg-input/30 relative flex h-12 flex-1 items-center justify-center rounded-md border text-base shadow-xs transition-all outline-none',
