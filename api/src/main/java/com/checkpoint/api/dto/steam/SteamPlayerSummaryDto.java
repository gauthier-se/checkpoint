 ...
 * @param communityVisibilityState profile visibility: 1 = private/friends-only, 3 = public.
 *                                Required by the library sync flow, which can only read
 *                                owned games when the value is 3.
 */
