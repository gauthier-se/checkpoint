...
/**
 * Request body for manually creating a video game via the admin API.
 * IGDB / Steam external identifiers are not exposed here: those are
 * managed by the import pipeline to preserve idempotency.
 */
